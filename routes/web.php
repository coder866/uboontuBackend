...
Route::any('payments/flutterwave/checkout', 'FlutterWaveController@initialize')->name('flutterwave.checkout');
// The callback url after a payment
Route::any('payments/flutterwave/callback', 'FlutterWaveController@icallback')->name('flutterwave.callback');


Route::get('firebase/sw-js','AppSettingController@initFirebase');

Route::get('privacy-policy', 'termsController@privacy');
Route::get('terms-of-use', 'termsController@termsOfUse');
Route::get('cancellation-and-refunds', 'termsController@cancellation');
