...
<body style="height: 100%; background-color: #f9f9f9;" class="hold-transition sidebar-mini {{setting('theme_color')}}">
    ...
    <div class="wrapper">
        ...
        <footer class="main-footer {{setting('fixed_footer','')}}">
            ...
            reserved.
            <span>&nbsp;|&nbsp;</span>
            <strong><a href="{{url('terms-of-use')}}">Terms of Use</a></strong>
            <span>&nbsp;|&nbsp;</span>
            <strong><a href="{{url('privacy-policy')}}">Privacy Policy</a></strong>
            <span>&nbsp;|&nbsp;</span>
            <strong><a href="{{url('cancellation-and-refunds')}}">Cancellation and Refunds</a>.</strong>
        </footer>
